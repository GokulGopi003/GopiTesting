Feature: PoS Inventory > Add Inventory
  ...
  Background: 
    ...
    #Then I press downArrow from element "div#ContentPlaceHolder1_lstLocation_chzn"  and click enter key
    #Then I press downArrow from element "div#ContentPlaceHolder1_lstVendor_chzn"  and click enter key
    Then I press downArrow from element "li#ContentPlaceHolder1_lstLocation_chzn_o_1"  and click enter key
    Then I need to click to autopopulate forElement "div#ContentPlaceHolder1_lstVendor_chzn.chzn-container.chzn-container-multi.chzn-container-active"
    Then I need to click to autopopulate forElement "li#ContentPlaceHolder1_lstVendor_chzn_o_1.active-result"
    Then I need to click on the dialogbox "Ok" button
