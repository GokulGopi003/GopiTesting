Feature: PoS Inventory > Add Inventory
  ...
  Background: 
    ...
    #Then I need to click on Vendor with text matching <ItemType>
  	...
  	Then I enter the value forElement "input#ContentPlaceHolder1_txtInventoryType.form-control-res" as "Bin"
  	Then I need to click on link with text matching "Bin"
  	Then I enter the value forElement "input#ContentPlaceHolder1_txtSelectedInventoryType.form-control-res" as "FDJBDAF"
  	Then I need to click on link with text matching "FDJBDAF"
    ...
    Then I need to click on the filter "Filter" button
  	...
  	#Examples: 
    #  | Vendor | Department | Category | Brand | SubCategory | Class | SubClass | Merchandise | Manufacture | Floor | Section | Bin | Shelf | Warehouse | ItemCode | ItemName | ItemType | Price | Gst | 
    #  | "205"        | ""  | ""       | ""       | ""      |
