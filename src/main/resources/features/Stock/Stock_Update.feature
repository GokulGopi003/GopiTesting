Feature: Stock > Stock update and Posting #done
  ...
  Scenario: checking for Stock update and posting
    Given I want to launch the "http://uniproonlineorder.ddns.net/Ent_SalesTeam_Demo/Stock/frmStockUpdate.aspx"
    ...
    And I click on the checkBox forElement "input#ContentPlaceHolder1_gvStockUpdate_chkSingle_0"
    Then I enter the value forElement "input#ContentPlaceHolder1_gvStockUpdate_txtNewQty_0" as "50"
    Given I need to click on the  element "a#ContentPlaceHolder1_lnkUpdate"
    Given I need to click on the  element "a#ContentPlaceHolder1_LinkButton3.button-blue"
    Given I need to click on the  element "a#ContentPlaceHolder1_LinkButton1.button-blue"
    And I click on the checkBox forElement "input#ContentPlaceHolder1_gvStockUpdate_chkSingle_0"
    Given I need to click on the  element "a#ContentPlaceHolder1_Delete.button-blue"
    Given I need to click on the  element "a#ContentPlaceHolder1_lnkYes.button-blue"
