Feature: PoS Inventory > Add Inventory
  ...
  Scenario Outline: Verifying Add Inventory Functionality Purchased by Cost
    Given I want to launch the "Managements/frmInventoryMovementWineReport.aspx"
    Then I load the testdatas form excel to table
    Then I load the InventoryMovementWiseReport sheet data to map
    Then I load the rowise InventoryMovementWiseReport data for "<TestcaseRowName>" rowname
