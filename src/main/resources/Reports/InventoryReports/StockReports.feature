Feature: PoS Inventory > Add Inventory
  ...
  Scenario Outline: Verifying Add Inventory Functionality Purchased by Cost
    Given I want to launch the "Reports/frmInventoryReport.aspx?id=Stock"
    Then I load the testdatas form excel to table
    Then I load the StockReports sheet data to map
    Then I load the rowise StockReports data for "<TestcaseRowName>" rowname
    Then I update value to the StockReports page global Variables
    Then I fill new StockReports data page using excel data
    Then I need to click on the  element "a#ContentPlaceHolder1_lnkLoadStockReport"
