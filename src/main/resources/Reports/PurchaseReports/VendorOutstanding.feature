Feature: PoS Inventory > Add Inventory
  ...
  Scenario Outline: Verifying Add Inventory Functionality Purchased by Cost
    Given I want to launch the "Reports/frmPurchaseReport.aspx?id=VendorPayment"
    Then I load the testdatas form excel to table
    Then I load the VendorOutstanding sheet data to map
    Then I load the rowise VendorOutstanding data for "<TestcaseRowName>" rowname
    ...
    Then I need to click on the  element "a#ContentPlaceHolder1_lnkVendorOsReport"
