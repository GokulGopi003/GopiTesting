		...
		try {
			...
			if (GenericWrappers.isNotEmpty(Globals.Inventory.Vendorbillno)) {
				...
				WebElement itemCodeValue = webDriver.findElement(
						By.cssSelector("#ContentPlaceHolder1_ddlVendorBillNo_chzn > div > div > input[type=text]"));
			...
			if (GenericWrappers.isNotEmpty(Globals.Inventory.Gidno)) {
				...
				// Globals.Inventory.Vendor);
				WebElement itemCodeValue = webDriver.findElement(
						By.cssSelector("#ContentPlaceHolder1_ddlGIDNo_chzn > div > div > input[type=text]"));
			...
			if (GenericWrappers.isNotEmpty(Globals.Inventory.ItemCode)) {
				...
				// WebElement itemCodeValue =
				// webDriver.findElement(By.cssSelector("input#ContentPlaceHolder1_txtItemCodeAdd"));
				// itemCodeValue.click();
				...
				try {
					...
					webDriver
							.findElement(By.cssSelector(
									"#dataGridBatchTable_master_row" + Globals.Inventory.Batchrowno + "> td.BatchNo"))
							.click();
				} catch (Exception e) {
			...
			if (GenericWrappers.isNotEmpty(Globals.Inventory.InvQty)) {
				webDriver.findElement(By.cssSelector("input#ContentPlaceHolder1_txtWQty")).sendKeys(Keys.SHIFT,
						Keys.LEFT);

				GenericWrappers.sleepInSeconds(1);
				webDriver.findElement(By.cssSelector("input#ContentPlaceHolder1_txtWQty")).sendKeys(Keys.DELETE);
			...
			if (GenericWrappers.isNotEmpty(Globals.Inventory.RecvQty)) {
				webDriver.findElement(By.cssSelector("input#ContentPlaceHolder1_txtLQty")).sendKeys(Keys.SHIFT,
						Keys.LEFT);
				GenericWrappers.sleepInSeconds(1);
			...
			if (GenericWrappers.isNotEmpty(Globals.Inventory.foc)) {
				webDriver.findElement(By.cssSelector("input#ContentPlaceHolder1_txtFOC")).sendKeys(Keys.SHIFT,
						Keys.LEFT);
				GenericWrappers.sleepInSeconds(1);
				webDriver.findElement(By.cssSelector("input#ContentPlaceHolder1_txtFOC")).sendKeys(Keys.DELETE);
			...
			if (GenericWrappers.isNotEmpty(Globals.Inventory.Reason)) {
				...
				// Globals.Inventory.Vendor);
				WebElement itemCodeValue = webDriver.findElement(
						By.cssSelector("#ContentPlaceHolder1_ddlRemarks_chzn > div > div > input[type=text]"));
			...
			pass.ExcelFourData("PR", "Modules", "Actual", "Expected", "Status", 0, 0, 0, 1, 0, 2, 0, 3);
...
// Xl sheet write
			pass.ExcelFourData("PR", "Filters", "Actual", "Expected", "Status", 0, 0, 0, 1, 0, 2, 0, 3);
		...
		while (rs.next()) {
			...
			case "tblPurchaseReturnHeader":
				...
				try {
					...
					pass.ExcelFourData("PR", "VendorCode", Globals.Inventory.Vendor, Sellingprice, "Pass", 5, 0, 5, 1,
							5, 2, 5, 3);
				} catch (AssertionError e) {
					pass.Excelcreate("PR", "tblPurchaseReturnHeader", "", 3, 0, 3, 1);
					pass.ExcelFourData("PR", "VendorCode", Globals.Inventory.Vendor, Sellingprice, "Fail", 5, 0, 5, 1,
							5, 2, 5, 3);
				} catch (Exception e) {
				...
				try {
					...
					pass.ExcelFourData("PR", "Date", Globals.Inventory.Date, ReturnDate, "Pass", 6, 0, 6, 1, 6, 2, 6,
							3);
				} catch (AssertionError e) {
					pass.ExcelFourData("PR", "Date", Globals.Inventory.Date, ReturnDate, "Fail", 6, 0, 6, 1, 6, 2, 6,
							3);
				} catch (Exception e) {
				...
				try {
					...
					pass.ExcelFourData("PR", "Reason", Globals.Inventory.Reason, ReturnDate1, "Pass", 7, 0, 7, 1, 7, 2,
							7, 3);
				} catch (AssertionError e) {
					pass.ExcelFourData("PR", "Reason", Globals.Inventory.Reason, ReturnDate1, "Fail", 7, 0, 7, 1, 7, 2,
							7, 3);
				} catch (Exception e) {
				...
				try {
					...
					pass.ExcelFourData("PR", "BasicCost", Globals.Inventory.BasicCost, Basiccost, "Pass", 8, 0, 8, 1, 8,
							2, 8, 3);
				} catch (AssertionError e) {
					pass.ExcelFourData("PR", "BasicCost", Globals.Inventory.BasicCost, Basiccost, "Fail", 8, 0, 8, 1, 8,
							2, 8, 3);
				} catch (Exception e) {
			...
			case "tblAPtransaction":
				...
				try {
					...
					pass.ExcelFourData("PR", "Vendor", Globals.Inventory.Vendor, Vendor, "Pass", 11, 0, 11, 1, 11, 2,
							11, 3);
				} catch (AssertionError e) {
					pass.Excelcreate("PR", "tblAPtransaction", "", 10, 0, 10, 1);
					pass.ExcelFourData("PR", "Vendor", Globals.Inventory.Vendor, Vendor, "Fail", 11, 0, 11, 1, 11, 2,
							11, 3);
				} catch (Exception e) {
				...
				try {
					...
					pass.ExcelFourData("PR", "Reason", Globals.Inventory.Reason, Promotiontodate, "Pass", 12, 0, 12, 1,
							12, 2, 12, 3);
				} catch (AssertionError e) {
					pass.ExcelFourData("PR", "Reason", Globals.Inventory.Reason, Promotiontodate, "Fail", 12, 0, 12, 1,
							12, 2, 12, 3);
				} catch (Exception e) {
			...
			case "tblVendorBalance":
				...
				try {
					...
					pass.ExcelFourData("PR", "Date", Globals.Inventory.Date, Promotionfromtime, "Pass", 15, 0, 15, 1,
							15, 2, 15, 3);
				} catch (AssertionError e) {
					pass.Excelcreate("PR", "tblVendorBalance", "", 14, 0, 14, 1);
					pass.ExcelFourData("PR", "Date", Globals.Inventory.Date, Promotionfromtime, "Fail", 15, 0, 15, 1,
							15, 2, 15, 3);
				} catch (Exception e) {
				...
				try {
					...
					pass.ExcelFourData("PR", "InvQty", Globals.Inventory.Vendor, WQty, "Pass", 16, 0, 16, 1, 16, 2, 16,
							3);
				} catch (AssertionError e) {
					pass.ExcelFourData("PR", "InvQty", Globals.Inventory.Vendor, WQty, "Fail", 16, 0, 16, 1, 16, 2, 16,
							3);
				} catch (Exception e) {
			...
			case "tblPurchaseReturnDetail":
				...
				try {
					...
					pass.ExcelFourData("PR", "ItemCode", Globals.Inventory.ItemCode, Foc, "Pass", 19, 0, 19, 1, 19, 2,
							19, 3);
				} catch (AssertionError e) {
					pass.Excelcreate("PR", "tblPurchaseReturnDetail", "", 18, 0, 18, 1);
					pass.ExcelFourData("PR", "ItemCode", Globals.Inventory.ItemCode, Foc, "Fail", 19, 0, 19, 1, 19, 2,
							19, 3);
				} catch (Exception e) {
				...
				try {
					...
					pass.ExcelFourData("PR", "foc", Globals.Inventory.InvQty, UnitCost, "Pass", 20, 0, 20, 1, 20, 2, 20,
							3);
				} catch (AssertionError e) {
					pass.ExcelFourData("PR", "foc", Globals.Inventory.InvQty, UnitCost, "Fail", 20, 0, 20, 1, 20, 2, 20,
							3);
				} catch (Exception e) {
				...
				try {
					...
					pass.ExcelFourData("PR", "foc", Globals.Inventory.RecvQty, SellingPrice, "Pass", 12, 0, 12, 1, 12,
							2, 12, 3);
				} catch (AssertionError e) {
					pass.ExcelFourData("PR", "foc", Globals.Inventory.RecvQty, SellingPrice, "Fail", 12, 0, 12, 1, 12,
							2, 12, 3);
				} catch (Exception e) {
					System.out.println("null error tblPurchaseReturnDetail column InvQty");
				}
				...
				try {
					...
					pass.ExcelFourData("PO", "foc", Globals.Inventory.foc, Foc1, "Pass", 13, 0, 13, 1, 13, 2, 13, 3);
				} catch (AssertionError e) {
					pass.ExcelFourData("PO", "foc", Globals.Inventory.foc, Foc1, "Fail", 13, 0, 13, 1, 13, 2, 13, 3);
				} catch (Exception e) {
				...
				try {
					...
					System.out.println(BasicCost);
					Assert.assertEquals(Globals.Inventory.BasicCost.trim(), BasicCost.trim());
					pass.ExcelFourData("PO", "foc", Globals.Inventory.BasicCost, BasicCost, "Pass", 14, 0, 14, 1, 14, 2,
							14, 3);
				} catch (AssertionError e) {
					pass.ExcelFourData("PO", "foc", Globals.Inventory.BasicCost, BasicCost, "Fail", 14, 0, 14, 1, 14, 2,
							14, 3);
				} catch (Exception e) {
