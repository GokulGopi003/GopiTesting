...
public class InventoryList extends PageObject {
	...
	public void i_update_value_to_the_InventoryList_page_global_Variables() {
		...
		Globals.Inventory.Floor = Globals.Inventory.InventoryListrowwiseData.get("Floor");
		...
		Globals.Inventory.Batch = Globals.Inventory.InventoryListrowwiseData.get("Batch");
