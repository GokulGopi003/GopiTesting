...
public class InventoryListtypefield {
	public String CompleteInfo_String ="input#ContentPlaceHolder1_chkCompleteInfo";
	public String ItemWise_String = "input#ContentPlaceHolder1_chkItemWise";
	public String BatchWise_String ="input#ContentPlaceHolder1_chkBatchwise";
	public String Batch_String ="//*[@id=\"ContentPlaceHolder1_chkBydate\"]";
	public String MarginNotSet_String ="input#ContentPlaceHolder1_chkMarginnotSet";
	public String DepartmentWise_String ="input#ContentPlaceHolder1_chkDepartmantWise";
	public String CategoryWise_String = "input#ContentPlaceHolder1_chkCategoryWise";
	...
	public String MaxQty_String ="input#ContentPlaceHolder1_rdoMaxQty";
	public String ItemNameChangeLog_string ="input#ContentPlaceHolder1_rdoitemChangelog";
	...
	public String ExpiredItem_String ="input#ContentPlaceHolder1_rdoExpired";
	public String SPlessNetCost_String = "input#ContentPlaceHolder1_rdoLessNetCost";
	...
	public String Brand_String ="input#ContentPlaceHolder1_ReportFilterUserControl_txtBrand";
