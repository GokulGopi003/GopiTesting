...
public class StokUpdateField {
	...
	public String Batch_String = "input#ContentPlaceHolder1_rbnBatch";
	public String Batch1_String = "input#ContentPlaceHolder1_rbnBatch";
	public String Batch2_String = "input#ContentPlaceHolder1_rbnNonBatch";
	public String Batch3_String = "input#ContentPlaceHolder1_chkActive";
	public String Batch4_String = "input#ContentPlaceHolder1_chkQtyGreater";
	public String Batch5_String = "input#ContentPlaceHolder1_chkQtyLess";
	public String Qty_String = "input#ContentPlaceHolder1_gvStockUpdate_txtNewQty_0";
