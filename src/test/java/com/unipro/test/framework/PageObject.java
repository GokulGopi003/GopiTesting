...
public abstract class PageObject {
	 ...
	 * @return true once the first element located by locator contains the given
	 *         text
	 */
	 ...
	 *            used to find the element
	 * @param text
	 *            to be present in the value attribute of the element found by the
	 *            locator
	 * @return true once the value attribute of the first element located by locator
